...
do 
    ...
    do
        ...
        do
            ...
            CUDA_VISIBLE_DEVICES=1 python -u 0_quant_long_logs/1_quant_prefill_thr.py --batch_size $bsz --tp $tp \
            ...
            CUDA_VISIBLE_DEVICES=1 python -u 0_quant_long_logs/0_quant_decoding_thr.py --batch_size $bsz --tp $tp \
                --quant_bits $quant_bits --quant_policy $quant_policy --prompt_length ${prompt_length} --model_path ${model_path}
            echo "------------------------ end \n"
            sleep 2
        done 
