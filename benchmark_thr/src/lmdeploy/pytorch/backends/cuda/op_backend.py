...
class CudaOpsBackend(DefaultOpsBackend):
    ...
    def get_layer_impl_builder(cls, layer_type: OpType):
        ...
        if layer_type == OpType.AttentionQuantFull:
            from .attention_quant_full import TritonAttentionQuantFullBuilder
            return TritonAttentionQuantFullBuilder
        elif layer_type == OpType.Attention:
    ...
    def update_step_context(cls, step_context):
        ...
        attn_metadata = attn_meta_cls(
            ...
            block_full_offsets=step_context.block_full_offsets,
        )
