...
class AttentionQuantFull(nn.Module):
    """Attention layer."""
    ...
    def __init__(
        ...
        **kwargs,
        ...
        impl_builder = layer_backend.get_layer_impl_builder(OpType.AttentionQuantFull)
    ...
    def forward(
        ...
        return self.impl.forward(
            ...
            k_cache,
            v_cache,
            k_full_cache=k_full_cache, 
            v_full_cache=v_full_cache,
