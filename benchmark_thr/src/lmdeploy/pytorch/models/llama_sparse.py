...
from ..evictutils.sparsekv_utils import init_pyramidkv,init_snapkv,init_H2O,init_StreamingLLM
import math
import time
from ..evictutils import global_timer as g_timer
...
def LlamaForCausalLM_forward_timing(
        ...
        if g_timer.forward_count == 1:
            ...
            # print(f"current forward_count: {g_timer.forward_count}")
