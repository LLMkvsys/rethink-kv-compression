...
def _fwd_kernel(
    ...
    off_v = (cur_kv_head * stride_vh + offs_dv[None, :] * stride_vd +
             offs_n[:, None] * stride_vbs)
    # print("stride_vh is ", stride_vh)
    # print("stride_boffb is ", stride_boffb)
    # print("shared_kv is ", shared_kv)
    q = tl.load(Q + off_q,
    ...
    block_offset_ptrs = Block_offsets + cur_batch * stride_boffb
    # print("BLOCK_M is", BLOCK_M) # 64
    # print("BLOCK_N is ", BLOCK_N) # 64
    # initialize pointer to m and l
...
def paged_attention_fwd(
    ...
    if not is_decoding:
        ...
        if quant_bits > 0:
            ...
            # print("k_scales_zeros shape ", k_scales_zeros.shape)
            # print("kv_seqlens ", kv_seqlens)
            # import pdb; pdb.set_trace() 
