...
if __name__ == "__main__":
    ...
    log_file = f"0_sparse_normal_logs/prefill_model_{model_ident}_batch_size_{args.batch_size}_tp_{args.tp}_quant_bits_{args.quant_bits}_quant_policy_{quant_method}_prompt_length_{args.prompt_length}.log"
