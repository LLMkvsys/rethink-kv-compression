...
<!--  -->
```shell
sudo docker run --gpus all --net host --shm-size 16g -v $(pwd):/opt/lmdeploy -v /home/wgao/.cache/huggingface/:/opt/huggingface --name lmdeploy -it openmmlab/lmdeploy:latest /bin/bash
```
