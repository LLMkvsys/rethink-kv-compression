...
prompt_length_list = [256, 512, 1024, 2048, 3072, 4000]
# bsz_list = [1, 2, 4, 8, 16]
bsz_list = [1]
...
for phase in ['prefill', 'decoding']:
    ...
    for idx, bsz in enumerate([1]):
        ...
        plt.grid()
        plt.savefig(f"{output_folder}/normal_phase_{phase}_bsz_{bsz}{suffix}.pdf", bbox_inches='tight')
        print(f"{output_folder}/normal_phase_{phase}_bsz_{bsz}{suffix}.pdf", flush=True)
        # plt.show()